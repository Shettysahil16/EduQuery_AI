      ...
      >
        ...
        {message.role === "ai" && !loading && (
          <div className="pl-8 mt-2 h-8 w-1/2 flex items-center gap-5">
            ...
            {!loading && (
              <div onClick={handleShare} className="relative group cursor-pointer flex justify-center items-center">
            ...
            {
              isShareVisible && (
                <ShareCard onClose={() => setShareVisible(false)} message={message.content}/>
              )
            }
          </div>
        )}
