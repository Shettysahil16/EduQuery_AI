                ...
                <form className="md:mt-4" onSubmit={handleSubmit}>
                    ...
                    <div className="text-xs md:text-xl flex flex-col gap-1">
                        ...
                        <div className="w-full bg-white rounded-xs py-2 text-slate-900 font-medium flex items-center">
                            ...
                            <div className="flex text-2xl px-2" onClick={() => setShowPassword(!showPassword)}>
                              {
                                data.password && (
                                  showPassword ? <IoMdEyeOff className="text-QuinaryText"/> : <IoMdEye className="text-QuinaryText"/>
                                )
                              }
                            </div>
                        </div>
                    ...
                    <div className="text-xs md:text-xl flex flex-col gap-1">
                        ...
                        <div className="w-full bg-white rounded-xs py-2 text-slate-900 font-medium flex items-center">
                            ...
                            <div className="flex text-2xl px-2" onClick={() => setShowConfirmPassword(!showConfirmPassword)}>
                              {
                                data.confirmPassword && (
                                  showConfirmPassword ? <IoMdEyeOff className="text-QuinaryText"/> : <IoMdEye className="text-QuinaryText"/>
                                )
                              }
                            </div>
                        </div>
                    </div>
                    <div onClick={handleSubmit} className="bg-Secondary text-PrimaryText text-center text-md md:text-2xl py-2 font-medium rounded-sm mt-3 md:mt-6 mb-2 md:mb-0 cursor-pointer">
                        Create an account
                    </div>
