          ...
          <form className="md:mt-4">
            <div className="flex flex-col gap-2 md:gap-4 text-white">
              ...
              <div className="text-xs md:text-xl flex flex-col gap-1">
                ...
                <p className="w-fit ml-auto font-normal text-sm md:text-lg cursor-pointer hover:underline">forget password?</p>
              </div>
              <div className="bg-Secondary text-PrimaryText text-center text-md md:text-2xl py-2 font-medium rounded-sm mt-3 md:mt-8 mb-2 md:mb-0 cursor-pointer">
                LOGIN
              </div>
              <div className="flex justify-center font-medium gap-1 md:gap-2 text-[10px] lg:text-base mt-4 pb-4">
                <p>DON’T HAVE AN ACCOUNT?</p>
                <Link to={"/signup"} className="text-PrimaryText cursor-pointer hover:scale-105 transition-all">
                  CREATE AN ACCOUNT
                </Link>
              </div>
            </div>
